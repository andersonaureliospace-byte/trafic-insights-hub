...
métricas reais são mostradas normalmente. O nome do cliente na tela
...
45. ~~Link direto pro Gerenciador de Anúncios no nome do cliente em
    Evolução (Etapa 51)~~ ✅ — o nome do cliente em cada linha da tela
