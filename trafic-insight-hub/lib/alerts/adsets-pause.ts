...
// bulk-status-update.ts e, desde agora, em creatives-pause.ts (mesmo bug,
// mesma correção: conta desmarcada do Painel mas ainda com meta de CPA
// cadastrada de antes continuava tendo conjuntos pausados sozinha).
